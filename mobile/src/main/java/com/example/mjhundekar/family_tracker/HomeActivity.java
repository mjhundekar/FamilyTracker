...
public class HomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.create_group) {
            ...
            Toast.makeText(this, "Create geo clicked", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.view_group) {
            Toast.makeText(this, "view group clicked", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.view_geofence) {
            Toast.makeText(this, "view geofence clicked", Toast.LENGTH_SHORT).show();
    ...
    private GoogleMap.OnMyLocationChangeListener myLocationChangeListener = new GoogleMap.OnMyLocationChangeListener() {
        ...
        public void onMyLocationChange(Location location) {
            ...
            markerName = mMap.addMarker(new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title("ME").icon(BitmapDescriptorFactory.fromBitmap(resizedBitmap)));
